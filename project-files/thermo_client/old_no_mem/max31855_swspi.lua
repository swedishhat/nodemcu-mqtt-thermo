...
function max31855_swspi_raw(format)
  assert(setup_complete,
    "\nERROR: Setup flag has not been set for max31855_swspi.setup()"..
  ...
  printformat = {
    ...
    function (x)
        ...
        raw_out = 
        "0x"..
        _base2base(table.concat(raw, "", 1, 4), 2, 16)..
        _base2base(table.concat(raw, "", 5, 8), 2, 16).." "..
        "0x"..
        _base2base(table.concat(raw, "", 9, 12), 2, 16)..
        _base2base(table.concat(raw, "", 13, 16), 2, 16).." "..
        "0x"..
        _base2base(table.concat(raw, "", 17, 20), 2, 16)..
        _base2base(table.concat(raw, "", 21, 24), 2, 16).." "..
        "0x"..
        _base2base(table.concat(raw, "", 25, 28), 2, 16)..
        _base2base(table.concat(raw, "", 29, 32), 2, 16)
    end
}

  assert(printformat[format],
    "\nERROR: Format argument for max31855_swspi.raw() not recognized.\n"..
